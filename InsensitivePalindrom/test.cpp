...
struct InsensitivePalindromTests : public ::testing::TestWithParam<std::pair<std::string, bool>> {};

TEST_P(InsensitivePalindromTests, CheckPalindrome) {
    EXPECT_EQ(isPalindrome(GetParam().first), GetParam().second);
}
